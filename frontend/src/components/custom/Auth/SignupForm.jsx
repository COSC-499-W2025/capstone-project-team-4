    ...
    >
      <Alert className="border-slate-200 bg-slate-50 text-slate-900">
        <AlertDescription className="flex gap-2 text-sm text-slate-700">
          ...
          <span>
            Create an account, then sign in to upload projects and generate
            resume output.
          </span>
        </AlertDescription>
      </Alert>
        ...
        <div className="space-y-2">
          ...
          {errors.email ? (
            ...
            <p className="text-xs text-slate-500">
              <strong className="font-semibold">Note:</strong> We'll use this
              for exports, account access, and viewing the commit heatmap that
              shares the same email as your GitHub.
            </p>
          )}
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-2 text-slate-500 hover:text-slate-900"
                aria-label={
                  confirmPass.show ? "Hide password" : "Show password"
                }
              >
                {confirmPass.show ? (
                  <EyeOff className="h-4 w-4" />

...
from backend.src.core.detectors.metadata import parse_metadata
from backend.src.core.analyzers.contributor import (
    analyze_contributors,
)
from backend.src.core.analyzers.project_stats import (
    analyze_project,
    project_analysis_to_dict,
    calculate_project_stats,
)
from backend.src.core.detectors.skill import analyze_project_skills

from backend.src.core.generators.resume import generate_resume_item

from backend.src.core.ranking.contribution import (
    rank_projects_for_contributor,
    summarize_top_projects,
)
from backend.src.core.ranking.log import (
    append_contribution_entry,
    rank_projects_from_log,
)
from src.core.project_summarizer import print_project_rankiprongs, SortCriteria

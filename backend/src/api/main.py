...
from src.api.routes import analysis, projects, skills, resume, user_profiles, auth, privacy_settings, experience, default_branch_stats, test_data
...
app.include_router(test_data.router, prefix=settings.api_prefix)

...
class TestSkillExtractor(unittest.TestCase):
    ...
    def test_get_language_line_counts(self, mock_get):
        ...
        """
        from src.core.skill_extractor import get_language_line_counts, _list_contents
    ...
    def test_get_repo_data(self, mock_get):
        ...
        """
        from src.core.skill_extractor import get_repo_data
    ...
    def test_get_skill_growth(self, mock_get):
        ...
        """
        from src.core.skill_extractor import EXT_SKILL_MAP
    ...
    def test_get_development_rhythm(self, mock_get):
        from src.core.skill_extractor import get_development_rhythm
    ...
    def test_get_technical_decisions(self, mock_get):
        from src.core.skill_extractor import get_technical_decisions
    ...
    def test_get_role_distribution(self, mock_get):
        from src.core.skill_extractor import get_role_distribution
